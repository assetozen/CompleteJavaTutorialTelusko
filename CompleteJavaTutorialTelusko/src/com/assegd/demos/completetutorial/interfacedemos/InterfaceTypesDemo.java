 ...
 * 1. Normal:-  if you have more than one method
...
public class InterfaceTypesDemo {
    public static void main(String[] args) {
        /** here we are trying to implement the show method of interface Abcde, since it only has one method we don't need to create an anonymous class for it
         * instead we create lambda expression create object of interface
         * - this is possible only for functional interfaces since they have only one method
         */
